...
namespace Xamarin.Android.Prepare
{
	partial class Configurables
	{
		partial class Urls
		{
			...
			public static readonly Uri MonoPackage = new Uri ("https://download.mono-project.com/archive/6.6.0/macos-10-universal/MonoFramework-MDK-6.6.0.153.macos10.xamarin.universal.pkg");
		}
